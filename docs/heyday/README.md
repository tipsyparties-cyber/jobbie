...
Everything planned for the Heyday websites, as of 13 September 2026. It was put together by Jem, with Claude.

## How to use it

1. Unzip it into `docs/heyday/` at the top of the jobbie repo.
2. Paste the build prompt into Claude Code. The prompt is `HEYDAY-JOBBIE-FULL-SITE-PROMPT.md`, and it's also on Jem's build page.

Where a document says `~/Projects/heyday-upandup-brief/`, it means this folder. The claude.ai links in the documents are Jem's private pages. Everything they show is in this pack.

## What's in it

| File | What it is |
|---|---|
| `HEYDAY-JOBBIE-FULL-SITE-PROMPT.md` | **Start here.** The build prompt: what we're trying to achieve, what to take from getjobber.com and honeybook.com, which document wins, the checklist of everything designed, the site map, page templates, where each kind of motion goes, and the build order |
| `DECISIONS-NEEDED.md` | Every placeholder still waiting for an answer, page by page, and who decides it. They stay visible as placeholders until answered |
| `spec/01-global-and-home.md` | Page-by-page spec, part 1: the parts every page shares (page structure, page transitions, the header menus in full, the footer, holding images, product illustrations, states, search and share images), then the homepage section by section |
| `spec/02-product-pages.md` | Part 2: How it works, the six group pages, All features, the AI page, integrations, What's new |
| `spec/03-feature-pages.md` | Part 3: the feature-page template, section by section, the list of every feature, and the new icons needed |
...
| `assets/heyday-wordmark.png` | Jem's Heyday wordmark |
| `assets/heyday-mark.svg` | The Heyday sun, the brand mark |
