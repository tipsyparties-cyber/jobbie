...
export function Footer() {
  return (
    <footer className="border-t border-ink/8 text-ink">
        ...
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-3">
              ...
              <a href="#" aria-label="Instagram" className="text-ink/40 hover:text-ink transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="flex items-center gap-6">
            {legalLinks.map((link) => (
              <Link key={link.href} href={link.href} className="text-xs text-ink/40 transition-colors hover:text-ink">
                {link.label}
              </Link>
            ))}
